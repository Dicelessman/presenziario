...
const UI = {
  ...
  renderPresenceTable() {
    ...
    body.innerHTML = ''; thDates.innerHTML = '<th rowspan="2" class="sticky left-0 !bg-green-800 !text-white !p-4 !border-r !border-white/50 text-left">Esploratore</th>'; thNames.innerHTML='';
